...
class AlarmTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "alarm-cell", for: indexPath)
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let alarmVC = AlarmDetailViewController()
        let navController = UINavigationController(rootViewController: alarmVC)
        //alarmVC.testlabel.text = "\(indexPath.row)"
